...
#ifndef NAV2_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_THROUGH_ROUTE_HPP_
#define NAV2_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_THROUGH_ROUTE_HPP_
...
#include "nav2_msgs/action/navigate_through_route.hpp"
...
/**
 * @class NavigateThroughRouteNavigator
 * @brief A navigator for navigating through a specified route
 */
class NavigateThroughRouteNavigator
  : public nav2_core::BehaviorTreeNavigator<nav2_msgs::action::NavigateThroughRoute>
{
public:
  using ActionT = nav2_msgs::action::NavigateThroughRoute;

  /**
   * @brief A constructor for NavigateThroughRouteNavigator
   */
  NavigateThroughRouteNavigator()
...
//   void onGoalPoseReceived(const geometry_msgs::msg::PoseStamped::SharedPtr pose);
   ...
   */
  std::string getName() override {return std::string("navigate_through_route");}
...
#endif  // NAV2_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_THROUGH_ROUTE_HPP_
